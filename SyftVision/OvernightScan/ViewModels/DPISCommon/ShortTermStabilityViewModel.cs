...
{
    class ShortTermStabilityViewModel : BindableBase, INavigationAware
    {
        ...
        public static readonly DependencyProperty AttachedChartProperty =
            DependencyProperty.RegisterAttached("AttachedChart", typeof(BaseChart), typeof(ShortTermStabilityViewModel), new PropertyMetadata(null, new PropertyChangedCallback((s, e) => {
