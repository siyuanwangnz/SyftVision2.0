...
{
    class SourceSwitchAndSettleTimeViewModel : BindableBase, INavigationAware
    {
        ...
        public void OnNavigatedTo(NavigationContext navigationContext)
        {
            ...
            SourceSwitchAndSettleTimeChart = navigationContext.Parameters.GetValue<BaseChart>("SourceSwitchAndSettleTimeChart");
        }
        ...
        public static readonly DependencyProperty AttachedChartProperty =
            DependencyProperty.RegisterAttached("AttachedChart", typeof(BaseChart), typeof(SourceSwitchAndSettleTimeViewModel), new PropertyMetadata(null, new PropertyChangedCallback((s, e) => {
