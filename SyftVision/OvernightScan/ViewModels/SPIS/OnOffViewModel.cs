...
{
    class OnOffViewModel : INavigationAware
    {
        ...
        public static readonly DependencyProperty AttachedChartProperty =
            DependencyProperty.RegisterAttached("AttachedChart", typeof(BaseChart), typeof(OnOffViewModel), new PropertyMetadata(null, new PropertyChangedCallback((s, e) => {
