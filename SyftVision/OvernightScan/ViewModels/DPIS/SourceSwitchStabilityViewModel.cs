...
{
    class SourceSwitchStabilityViewModel : BindableBase, INavigationAware
    {
        ...
        public void OnNavigatedTo(NavigationContext navigationContext)
        {
            ...
            ReagentRSDChart = navigationContext.Parameters.GetValue<BaseChart>("ReagentRSDChart");
            PosWetReagentChart = navigationContext.Parameters.GetValue<BaseChart>("PosWetReagentChart");
            NegWetReagentChart = navigationContext.Parameters.GetValue<BaseChart>("NegWetReagentChart");
            NegDryReagentChart = navigationContext.Parameters.GetValue<BaseChart>("NegDryReagentChart");
        }
        ...
        public static readonly DependencyProperty AttachedChartProperty =
            DependencyProperty.RegisterAttached("AttachedChart", typeof(BaseChart), typeof(SourceSwitchStabilityViewModel), new PropertyMetadata(null, new PropertyChangedCallback((s, e) => {
