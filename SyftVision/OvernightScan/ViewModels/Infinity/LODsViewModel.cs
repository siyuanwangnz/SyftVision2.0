...
{
    class LODsViewModel : BindableBase, INavigationAware
    {
        ...
        public void OnNavigatedTo(NavigationContext navigationContext)
        {
            ...
            LODsChart = navigationContext.Parameters.GetValue<BaseChart>("LODsChart");
        }
        ...
        public static readonly DependencyProperty AttachedChartProperty =
            DependencyProperty.RegisterAttached("AttachedChart", typeof(BaseChart), typeof(LODsViewModel), new PropertyMetadata(null, new PropertyChangedCallback((s, e) => {
