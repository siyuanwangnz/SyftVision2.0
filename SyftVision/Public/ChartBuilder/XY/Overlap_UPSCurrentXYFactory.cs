...
{
    public class Overlap_UPSCurrentXYFactory : OverlapLineXYFactory
    {
        public override void AddLayer(List<XYItem.Layer> layerList, in Component component, in ChartProp chartProp, in ScanFile scanFile)
        {
            ...
            if (rcData.IsAvailable) layerList.Add(new XYItem.Layer(rcData.CurTimeList(), rcData.UPSCurList(), scanFile.File));
        }
    }
}
